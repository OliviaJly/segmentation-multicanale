# -*- coding: utf-8 -*-
"""
Created on Fri Feb 17 16:19:33 2017
...
# Import des données
df = pd.read_csv(path +'/OLIVIA_BASE_PART_032016.csv', nrows=20000, delimiter=";",
                 encoding="ISO-8859-1",
...
base_quanti2 = base_quanti2.drop(['DEPENSES_RECURRENTES_EST_M', 'SMS_recus_3m',
                                  ...
                                  'Appels_entrants_3m'], axis=1)
# 'Connexion_MABANQUE_CR', 'Connexion_CAEL_CR', 'Actions_CAEL_CR', 'Actions_MABANQUE_CR'

# base_quanti2 est la même base d'étude que pour l'ACP sous SAS


# Enregistre la base en csv :
base_quanti2.to_csv(path + '/quanti_trans2juin.csv', index=False)
